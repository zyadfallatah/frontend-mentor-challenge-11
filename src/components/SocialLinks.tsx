...
const SocialLinks = ({ user }: { user: UsernameSchema }) => {
  return (
    <div className="grid md:grid-cols-2 mt-6 gap-4 md:gap-x-6">
      <SocialLink linkName={user?.location}>
        <svg height="20" width="14" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fill="#4b6a9b"
            className={isLinkDefined(user?.location)}
          />
        </svg>
      </SocialLink>

      <SocialLink linkName={user?.twitter_username}>
        <svg height="18" width="20" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fill="#4b6a9b"
            className={isLinkDefined(user?.twitter_username)}
          />
        </svg>
      </SocialLink>

      <SocialLink linkName={user?.blog}>
        <svg
          height="20"
          width="20"
          fill="#4b6a9b"
          className={isLinkDefined(user?.blog)}
      ...
      <SocialLink linkName={user?.company}>
        <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
          <g fill="#4b6a9b" className={isLinkDefined(user?.company)}>
